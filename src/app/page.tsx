    ...
    <div className="flex flex-col">
      ...
      <section className="bg-gray-100 py-20">
        <div className="container mx-auto px-6">
          <h3 className="text-3xl font-bold text-center text-purple-700 mb-4">
            How can CCNY Connect help me?
          </h3>
          <p className="text-center text-gray-700 mb-12">
            With CCNY Connect, you have a one stop hub for help, communication
            and resources.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center">
              ...
              <h4 className="font-semibold text-xl text-purple-700 mb-2">
                Get your questions answered
              </h4>
              <p className="text-gray-600">
                Ask questions to your network on course topics, assignments and
                much more!
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Find resources to help you study and ace your classes with the
                expanding resource library. Have a resource to share? Upload it
            ...
            <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Find people who are comfortable helping in different courses.
                Feel like helping out in a course? Indicate so on your profile
                and watch the dms flow.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Find mutual peers in courses you're taking, and message them
                here!
              </p>
            </div>
          </div>
      ...
      <footer className="bg-black text-white pt-12 pb-6">
        <div className="container mx-auto px-6 text-center mb-6"></div>
